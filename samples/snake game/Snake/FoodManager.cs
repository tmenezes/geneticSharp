...
namespace Snake
{
    ...
    public class FoodManager
    {
        ...
        private readonly int m_GameWidth; // Game window size in pixels to ensure the program draws within the screen
        private readonly int m_GameHeight;

        internal FoodPellet LastFood { get; private set; }
        ...
        public void AddRandomFood()
        {
            ...
            LastFood = new FoodPellet(X, Y);
            m_FoodPellets.Add(LastFood); // Save pellet object
        }
